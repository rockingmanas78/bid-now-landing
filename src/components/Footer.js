            ...
            <div className="flex flex-col sm:flex-row justify-between items-center sm:items-start max-w-6xl mx-auto">
                ...
                <div className="text-center sm:text-left">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                        ...
                        <Link href="/terms" className="text-white text-left hover:text-orange-500 transition duration-300">Terms & Conditions</Link>
                        <Link href="/privacy" className="text-white text-left hover:text-orange-500 transition duration-300">Privacy Policy</Link>
